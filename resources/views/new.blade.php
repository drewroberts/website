                ...
                <div class="mx-auto max-w-7xl px-8">
                    ...
                    <div class="hidden border-t border-white border-opacity-20 py-5 lg:block">
                        ...
                        <div class="col-span-2">
                            ...
                            <a href="#" class="text-white rounded-md bg-white bg-opacity-0 px-3 py-2 text-sm font-medium hover:bg-opacity-10" aria-current="page">About</a>
                            <a href="#" class="text-indigo-100 rounded-md bg-white bg-opacity-0 px-3 py-2 text-sm font-medium hover:bg-opacity-10">Consultations</a>
                            <a href="#" class="text-indigo-100 rounded-md bg-white bg-opacity-0 px-3 py-2 text-sm font-medium hover:bg-opacity-10">Appointments</a>
                            <a href="#" class="text-indigo-100 rounded-md bg-white bg-opacity-0 px-3 py-2 text-sm font-medium hover:bg-opacity-10">Cryptocurrency</a>
                            <a href="#" class="text-indigo-100 rounded-md bg-white bg-opacity-0 px-3 py-2 text-sm font-medium hover:bg-opacity-10">Programming</a>
                            </nav>
                        </div>
                        <div>
