...
<body>
    ...
    <div class="bg-black">
        <nav class="max-w-screen-2xl mx-auto px-4 py-4">
    ...
    <div class="page-content-wrapper">
                ...
                <div class="cinema-screen flex flex-col sm:flex-row">
                    ...
                    <div class="playlist-element w-full sm:w-1/3 bg-black p-4">
                        <div class="tabContainer">
                            ...
                            <!-- Tab headings -->
                            <div class="tabButtons flex w-full mb-4">
                                <!-- Playlist Tab -->
                                <div role="tab" class="tabButton px-4 py-2 text-white uppercase w-full cursor-pointer mr-4" aria-controls="playlistTab">Playlist</div>

                                <!-- Trending Tab -->
                                <div role="tab" class="tabButton px-4 py-2 text-white uppercase w-full cursor-pointer" aria-controls="trendingTab">Trending</div>
                            </div>

                            <!-- Playlist TabContent  -->
                            <div id="playlistTab" role="tabpanel" class="tabContent w-full">
                                <ul class="playlist-rows">
                                    @for ($i = 0; $i < 6; $i++) <li class="playlist-row mb-4">
                                ...
                                <ul class="playlist-rows">
                                    @for ($i = 0; $i < 6; $i++) <li class="playlist-row mb-4">
                                        <a href="/amp/video" class="flex items-center space-x-4">
                                            ...
                                            <div class="info">
                                                <div class="series_episode text-xs text-gray-400 mb-1">How-To 2/ S5 EP19</div>
                                                <p class="episode_title text-xs text-white">2 Pizza Pocket with Matty Matheson</p>
                                            </div>
                                        </a>
                                        </li>
                                        @endfor
        ...
        <!-- page content -->
        <div class="max-w-screen-2xl pt-4 pb-4 mx-auto">
            <div class="flex">
                <!-- 70% space -->
                <div class="w-2/3">
                    <article class="flex">
                        <div class="w-full">
                            <div class="p-4">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h6 class="text-xs"><a href="/amp" class="text-xs">
                                                <div class="text-xs mb-1 font-bold"><span>AMP / EP1</span></div>
                                            </a></h6>
                                    </div>
                                ...
                                <div class="my-4">
                                    ...
                                    <div class="my-4">
                                        <div class="w-full flex items-center space-x-12 mb-4">
                                            <div class="flex flex-col">
                                                <h4 class="text-xs">Topic</h4>
                                            </div>
                                            <div class="flex flex-col">
                                                <a href="/amp" class="text-xs">AMP</a>
                                            </div>
                                        </div>
                                        <div class="w-full flex items-center space-x-12 mb-4">
                                            <div class="flex flex-col">
                                                <h4 class="text-xs">Runtime</h4>
                                            </div>
                                            <div class="flex flex-col">
                                                <span class="text-xs">21:58</span>
                                            </div>
                                        </div>
                ...
                <div class="slider-container">
                    <div class="slider-wrapper">
                        <div class="header text-lg font-bold mr-3">
                            <section>
                                <h3 class="font-bold text-3xl uppercase">AMP Tutorials</h3>
                            </section>
                        </div>
                        ...
                        <div class="carousel-container">
                            <div class="carousel flex flex-no-wrap overflow-x-auto" style="height: auto; min-width: 100%;">
                                <!-- Loop starts here -->
                                @for ($i = 1; $i <= 5; $i++) <div class="slick-slide">
                                    <a href="/amp/video" class="flex flex-col mr-4">
                                        <div class="small">
