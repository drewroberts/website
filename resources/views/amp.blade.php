...
<style amp-custom>
		...
		*,::after,::before{-webkit-box-sizing:inherit;box-sizing:inherit;margin:0;padding:0;position:relative}
		...
		.sticky-header {flex-grow: 1; max-width: 1480px; margin:0 auto;}
		.sticky-header a {margin: 8px 15px; width: 184px; height: 34px; display: block; float:left;}
				...
				custom-validation-reporting="show-first-on-submit">
					...
					<div class="newsletter p-4-xs p-5-m dsp-flex-xs flex-wrap col-12-xs">
						<div class="newsletter__text col-12-xs">
							...
							<p class="newsletter__subheading hed-xs">Sign up for programming tips and other personalized insights from Drew Roberts, delivered to your inbox weekly.</p>
						</div>
