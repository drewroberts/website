...
<head>
  ...
  <title>Furniture from America's Office Source</title>
  <meta name="description" content="" />
  <link rel="canonical" href="https://drewroberts.com/aos" />
...
<!-- Start of DoubleClick Floodlight Tag: Please do not remove Activity name of this tag: GAnalytics-Optimize-PageLand URL of the webpage where the tag is expected to be placed: https://optimize.withgoogle.com This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag. Creation Date: 03/19/2018 --><script type="text/javascript" nonce="wH2m9uMxaM">var axel = Math.random() + ""; var a = axel * 10000000000000; document.write('<img src="https://ad.doubleclick.net/ddm/activity/src=2507573;type=googl001;cat=ganal002;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;ord=' + a + '?" width="1" height="1" alt=""/>');</script><noscript>

<img src="https://ad.doubleclick.net/ddm/activity/src=2507573;type=googl001;cat=ganal002;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;ord=1?" width="1" height="1" alt=""/></noscript><!-- End of DoubleClick Floodlight Tag: Please do not remove -->
...
<section id="main">
  ...
  <section class="grid container">
    <div class="row">
      <div class="col">
        <img src="https://optimize.withgoogle.com/assets/optimize-chart.png" alt="Chart">
      ...
      <div class="col">
        <img src="https://optimize.withgoogle.com/assets/optimize-laptop.png" alt="Laptop">
        <h3>Test what works best</h3>
        <p>Easily run A/B tests on your website&#39;s content to learn what works best for your visitors.</p>
      </div>
      <div class="col">
        <img src="https://optimize.withgoogle.com/assets/optimize-calendar.png" alt="Calendar">
      ...
      <div class="col">
        <img src="https://optimize.withgoogle.com/assets/optimize-clipboard.png" alt="Clipboard">
  ...
  <!-- <section class="logos"><h3>Trusted by brands, big and small</h3><div class="row"><div class="col"><img src="https://optimize.withgoogle.com/assets/airbnb.svg" alt="airbnb"></div><div class="col"><img src="https://optimize.withgoogle.com/assets/airbnb.svg" alt="airbnb"></div><div class="col"><img src="https://optimize.withgoogle.com/assets/airbnb.svg" alt="airbnb"></div><div class="col"><img src="https://optimize.withgoogle.com/assets/airbnb.svg" alt="airbnb"></div><div class="col"><img src="https://optimize.withgoogle.com/assets/airbnb.svg" alt="airbnb"></div><div class="col"><img src="https://optimize.withgoogle.com/assets/airbnb.svg" alt="airbnb"></div></div></section> -->
  <section class="laptop">
    <h3>One, two, three, optimize.</h3>
    <img class="gif" src="https://optimize.withgoogle.com/assets/optimize-bottom.gif" alt="Optimize">
    ...
    <section class="cta">
      ...
      <div class="outbound">
        <a id="outbound" target="_blank" rel="noopener" href="https://www.google.com/analytics/optimize/" data-g-event="Optimize: Microsite" data-g-action="Learn More" data-g-label="One Two Three Optimize">Learn More <img class="image" src="https://optimize.withgoogle.com/assets/nextarrow.svg" alt="Next Arrow"></a>
      </div>
    </section>
  </section>
  <footer class="footer">
    <div class="container">
      <a class="google-logo" target="_blank" rel="noopener" href="https://www.google.com/" data-g-event="Optimize: Microsite" data-g-action="Logo" data-g-label="Footer"><img id="googlefooter" src="https://optimize.withgoogle.com/assets/footer-google-logo.svg" alt="Google Logo"></a>
      <ul class="links">
      ...
      <div class="language"><a target="_blank" rel="noopener" href="https://support.google.com/360suite/optimize#topic=6314903" data-g-event="Optimize: Microsite" data-g-action="Help" data-g-label="Footer"><span><img src="https://optimize.withgoogle.com/assets/help.svg" alt="Help Icon"></span> Help</a></div>
    </div>
  </footer>
</section>
