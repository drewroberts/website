        ...
        <template slot="field">
            <div class="flex items-center">
                ...
                >
                    <div slot="default" v-if="selectedResource" class="flex items-center">
                        <div class="mr-3">
                            <country-flag :country="getCountryFromPhoneNumber(selectedResource.display)" size="small"/>
                        </div>
                    ...
                    >
                        <div class="mr-3">
                            <country-flag :country="getCountryFromPhoneNumber(option.display)" size="small"/>
                        </div>
                ...
                <add-phone-number-button
                    v-if="canShowAddPhoneNumberModal"
                    @click="openAddPhoneNumberModal"
                    class="ml-1"
                    :dusk="`${field.attribute}-inline-add-phone-number`"
                />
            </div>
            ...
            <portal to="modals" transition="fade-transition">
                <add-phone-number-modal
                    v-if="addPhoneNumberOpen && canShowAddPhoneNumberModal"
                    @set-phone-number="handleSetPhoneNumber"
                    @cancelled-add="closeAddPhoneNumberModal"
                    :resource-name="field.resourceName"
                    :resource-id="resourceId"
                    :via-relationship="viaRelationship"
                    :via-resource="viaResource"
...
export default {
    ...
    methods: {
        ...
        openAddPhoneNumberModal() {
            this.addPhoneNumberOpen = true
        },

        closeAddPhoneNumberModal() {
            this.addPhoneNumberOpen = false
        },
        ...
        handleSetPhoneNumber({id}) {
            this.closeAddPhoneNumberModal()
            this.selectedResourceId = id
            this.initializingWithExistingResource = true
            this.getAvailableResources().then(() => this.selectInitialResource())
        },
    ...
    computed: {
        ...
        canShowAddPhoneNumberModal() {
            return this.field.showAddPhoneNumberButton;
        },
